...
class UserViewsTest(TestCase):
    ...
    def test_user_signup_post_success(self):
        ...
        Ensure the user is created and redirected to the home page after a successful signup.
        """
    ...
    def test_password_reset_get(self):
        ...
        Ensure the password reset page loads correctly with the right template and form.
        """
    ...
    def test_password_reset_post_failure(self):
        """
        Test the POST request for the password reset view with an invalid email.
        Ensure the user is redirected and no email is sent.
        """
    ...
    def test_user_profile(self):
        ...
        Ensure the profile page loads correctly with the right template and form.
        """
    ...
    def test_change_password_get(self):
        ...
        Ensure the change password page loads correctly with the right template and form.
        """
        self.client.login(username='testuser', password='password')
    ...
    def test_change_password_post_success(self):
        ...
        Ensure the user is redirected to the profile page after a successful password change.
        """
        self.client.login(username='testuser', password='password')
    ...
    def test_change_password_post_failure(self):
        ...
        Ensure the change password page reloads with the form and error messages.
        """
        self.client.login(username='testuser', password='password')
        response = self.client.post(reverse('change_password'), {
            'old_password': 'password',
